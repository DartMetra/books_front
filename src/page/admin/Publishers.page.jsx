...
export function PublishersAdminPage() {
  ...
  return (
    <>
      ...
      <Link to="/admin/publisher/create">
        <button className="tm-btn tm-btn-primary tm-btn-small">Додати видавництво</button>
      </Link>
      {/*BOOKS*/}
      <div className="row tm-row">
        {publishers.publishers.map((publisher) => (
          <PublisherGrid publisher={publisher} key={publisher._id} admin={true} />
        ))}
      </div>
